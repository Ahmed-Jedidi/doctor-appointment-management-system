...
<%@page import="dao.RdvDaoImpl"%>
<%@page import="dao.RdvDao"%>
<%@page import="dao.SpecialiteDaoImpl"%>
...
<title>Home Page | Doctolib</title>
...
<!-- /////////////////////////////////////////////////////////////////////////////// -->
		...
		<p class="text-center text-danger fs-3">Dashboard du platform</p>
		...
		MedecinDao medDAO = new MedecinDaoImpl(singleton.getConnection());
		UserDao usDAO = new UserDaoImpl(singleton.getConnection());
		RdvDao rdvDAO = new RdvDaoImpl(singleton.getConnection());
		SpecialiteDao specDAO = new SpecialiteDaoImpl(singleton.getConnection());
		
		int totalNumberOfMedecin = medDAO.countTotalMedecin();
		int totalNumberOfUser = usDAO.countTotalUser();
		int totalNumberOfRdv = rdvDAO.countTotalRdvs();
		int totalNumberOfSpecialite = specDAO.countTotalSpecialite();
		%>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="card my-card">
					<div class="card-body text-center text-danger">
						...
						<p class="fs-4 text-center"> Medecin <br><%= totalNumberOfMedecin %>
			...
			<div class="col-md-4">
				<div class="card my-card">
					<div class="card-body text-center text-danger">
						...
						<p class="fs-4 text-center"> User <br><%= totalNumberOfUser %> </p>
					</div>
				</div>
			...
			<div class="col-md-4">
				<div class="card my-card">
					<div class="card-body text-center text-danger">
						...
						<p class="fs-4 text-center"> Rendus-vous <br><%= totalNumberOfRdv %> </p>
					</div>
				</div>
			...
			<div class="col-md-4 mt-2">
				<div class="card my-card" data-bs-toggle="modal"
					...
					<div class="card-body text-center text-danger">
						<i class="fa-solid fa-user-doctor fa-3x"></i><br>
						<p class="fs-4 text-center"> Specialite <br><%= totalNumberOfSpecialite %>
						</p>
					</div>
				</div>
	...
	<div class="container p-3">
		<p class="text-center mt-2 mb-5 fs-2 myP-color">Quelques caractéristiques clés du plateforme </p>
		<div class="row">
			<!-- 1st col -->
	...
	<div class="container p-2">
		<p class="text-center fs-2 myP-color">Notre Equipe</p>
		<div class="row">
			<div class="col-md-6">
				<div class="card my-card">
					<div class="card-body text-center">
						<img alt="" src="img/friend_02.jpg" height="500px" width="500px">
						<p class="fw-bold fs-5">Omar Khelifi</p>
						<p class="fs-7">( Engineer )</p>
					</div>
				</div>
			</div>
			<div class="col-md-6">
				<div class="card my-card">
					<div class="card-body text-center">
						<img alt="" src="img/friend_01.png" height="500px" width="500px">
						<p class="fw-bold fs-5">Dr. Ahmed Jedidi</p>
						<p class="fs-7">( Business man )</p>
					</div>
				</div>
			</div>
