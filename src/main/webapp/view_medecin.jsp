					...
					<div class="card-body">
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								List<Medecin> listOfMed = medDao.getAllMedecins();
								for (Medecin medecinLst : listOfMed) {
								%>
								<tr>
									<%-- <th scope="row"><%= doctorLst.getId()%></th> --%>
									<th><%=medecinLst.getNom()%></th>
									<td><%=medecinLst.getSpecialite()%></td>
									<td><%=medecinLst.getVille()%></td>
									<td><%=medecinLst.getAdresse()%></td>
									<td><%=medecinLst.getEmail()%></td>
									<td><%=medecinLst.getPhone()%></td>


									<td><a class="btn btn-sm btn-success" href="user_rdv.jsp?id=<%=medecinLst.getId()%>">Prend Rendus-vous</a></td>
