					...
					<div class="card-body">
						...
						<form action="user_register" method="post">
							<div class="mb-3">
								...
								<input name="nom" type="text" placeholder="Entrer Nom" class="form-control" required="required">

							</div>
							<div class="mb-3">
								<label class="form-label">Email address</label> 
								<input name="email" type="email" placeholder="Entrer Email" class="form-control" required="required">
								<div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
							</div>
							<div class="mb-3">
								<label class="form-label">Password</label> 
								<input name="password" type="password" placeholder="Entrer password" class="form-control" required="required">
							</div>
